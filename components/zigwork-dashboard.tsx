        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-hidden mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 max-w-2xl h-[calc(100vh-360px)]">
              ...
              <Card
                className="bg-transparent border-2 border-dashed border-gray-600 rounded-xl cursor-pointer"
                onClick={() => {
                ...
                {[...Array(10)].map((_, i) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Create{" "}
                      <span className="font-bold text-black">UGC Videos</span>{" "}
                      and get shares on Instagram about Myntra Showbizz
                    </p>
                  </div>
                ))}
              </div>
