...
export default function PendingApprovalPage({
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
      <div className="w-full max-w-xl bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-800">
        <div className="mb-4">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-yellow-500/20 text-yellow-400">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 9v4"/><path d="M12 17h.01"/><path d="M21 10c0 6-9 12-9 12S3 16 3 10a9 9 0 1 1 18 0Z"/></svg>
          </div>
        </div>
          ...
          {isCompany ? (
            <>
              ...
              <Link
                ...
                className="px-4 py-2 rounded-lg bg-gray-800 text-white hover:bg-gray-700 border border-gray-700 transition-colors"
              >
