...
export default function CompaniesProfile() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 403) {
          ...
          setError(
            "This account is not associated with a company. Please use a company account to access this page."
          );
        } else if (response.status === 404) {
          // Company not found
          setError(
            "Company profile not found. Please contact support if you believe this is an error."
          );
        } else {
          // Other errors
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col lg:ml-64">
